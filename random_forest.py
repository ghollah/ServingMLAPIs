...
def runModel(): 
	...
	predictor_var = request.get_json().get('predictor_var')  
...
# Random Forest classifier model
	...
	result = runns(resp_var, size_of_test_data,dataset,positive_class,predictor_var, n_estimators,important_features,dealing_with_nulls)
